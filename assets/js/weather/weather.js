...
function showData(DataWeather) {
    ...
    showFinal.innerHTML = `
    <div class="weather-data f-w-800 f-20">${finalTemp}<sup>&#176</sup>C</div><div class="weather-description font-warning f-w-700 text-capitalize"">${DataWeather.weather[0].description}</div><p class="city-name f-10">Beautiful Day in ${DataWeather.name}</p>`;
